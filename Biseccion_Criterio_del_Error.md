...
donde no existe una solución analítica cerrada, por lo que se recurre a **métodos numéricos iterativos**. Uno de los métodos más robustos y conceptualmente simples es el **método de la bisección**, el cual se basa en el **Teorema del Valor Intermedio**.
...
Este método garantiza convergencia, aunque puede ser lento comparado con otros métodos.
...
[
\delta_r = \left|\frac{x_{k}-x_{k-1}}{x_k}\right|
]
...
1. ¿Cuántas iteraciones del método de la bisección son necesarias para aproximar la raíz de
   [
   x^3 - 4x - 9 = 0
   ]
   con **8 cifras significativas**?

2. Desarrolle un **Live Script en MATLAB** que:
